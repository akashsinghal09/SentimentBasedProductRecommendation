...
model = pk.load(open('pickle_file/RandomForest_classifier.pkl','rb'))                          # Classification Model
...
def recommend_products(user_name):
    ...
    product_frame = product_df[product_df.id.isin(product_list.index.tolist())]
